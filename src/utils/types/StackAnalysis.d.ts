...
export declare class StackAnalysis {
    ...
    static register(name: string, // 函数名称
        parent: Record<PropertyKey, any>, // 函数父对象
        deep: number, // 递归层数
        isAction: boolean): void;
 ...
 * @returns
 */
export declare function sa(name?: string): (target: ClassTarget | MethodTarget, property?: string, descriptor?: PropertyDescriptor) => void;
export { };
/** ********************************************** 结束（最后的分割线） ************************************************** **/
